    ...
    <div class="card-body">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="pull-left">
                    <h3>Lista  de Pregunta</h3>
                </div>

                <a href="{{ route('Pregunta.create') }}" class="btn btn-outline-primary btn-block">Añadir Pregunta</a>

            </div>
            <br>
            
            <div class="table-responsive">
                <table id="tblpreguntas" class="mb-0 table table-bordered table-hover table-sm table-bordered" style="width:100%" cellspacing="0">
                    <thead>
                        <!--  <th scope="col">Id</th> -->
